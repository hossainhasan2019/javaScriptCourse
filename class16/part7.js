...
function showTotalExpense(){
    ...
    //filter and deduce method dia kora

    let totalExpense = items    
    .filter((item) => item.type === '-')
    .reduce((expence , item) => expence + parseInt(item.value), 0)
...
//part6666666666666666666666666666666666666666666
//income and expence jog kora
...
function showTotalBalance(){
    ...
    //usage tarnary oprator to online 
...
function getItemsfromLs(){
    ...
    //usage tarnary oprator to short line code
...
//part 77777777777777777777777


// string or integer ja ei hok na kno 
//sob gula k koma dara separet korbo 
...
// tar jonno ekta function banano 
